function getData(location) {
    return fetch("https://data.bmkg.go.id/DataMKG/MEWS/DigitalForecast/DigitalForecast-NusaTenggaraBarat.xml") // Fetch API Data BMKG
...
// Memanggil fungsi
weatherPanel(["Gerung", "Mataram", "Selong", "Dompu"])
...
function timeout() {
    setTimeout(function () {
        weather(["Gerung", "Mataram", "Selong", "Dompu"])
        timeout2();
    }, 20000);
}
